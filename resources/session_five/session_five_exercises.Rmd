...
2. Create a bar plot of the cylinder numbers in the `mpg` dataset and convert it into a Coxcomb plot using `coord_polar("y")` (alternatively use `coord_flip()` followed by `coord_polar()`)
