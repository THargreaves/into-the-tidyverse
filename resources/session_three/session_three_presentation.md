...
diamonds %>%
  ...
  ggplot(aes(x = cut, y = med_vol)) +
    # geom_point is not the best choice here
    # we will learn better alternatives in session 5
    geom_point() +
    # set group = -1 so that line of best fit is for all points
