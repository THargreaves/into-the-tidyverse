...
=======
1. Now using `arrange()` find the car in the `mpg` dataset with the best city mileage. What about the worst?
>>>>>>> 428e31f973b654df8e2804f7faaa8904a8d846df
...
=======
1. Create a new column called `cty_km_l` which measures the city mileage in kilometres per litre (Hint: 1 mile ~ 1.6 km, 1 gallon ~ 3.8 litres)
>>>>>>> 428e31f973b654df8e2804f7faaa8904a8d846df
...
<<<<<<< HEAD
5a. **(VERY HARD)** What is the output of `as.integer(weather$date)`? Create a column in the dataset representing the numerical form of the date.
5b, April 1st 2015 was a Wednesday, use some modular arithmetic to create a column containing the date of the week as a number - e.g. Thursday = 4. (Hint: `(date_numeric + 1) %% 7 + 1`)
=======
...
April 1st 2015 was a Wednesday, use some modular arithmetic to create a column containing the date of the week as a number - e.g. Thursday = 4. (Hint: `(date_numeric + 1) %% 7 + 1`)
>>>>>>> 428e31f973b654df8e2804f7faaa8904a8d846df
